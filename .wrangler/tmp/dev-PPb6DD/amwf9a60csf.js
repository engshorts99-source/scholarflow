...
// .wrangler/tmp/bundle-5s1gJu/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-FCKRt7/bundledWorker-0.40766335063109027.mjs
...
var oe = /* @__PURE__ */ __name2((e, t, n, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let r of ae(t))
      !ie.call(e, r) && r !== n && U(e, r, { get: () => t[r], enumerable: !(s = ne(t, r)) || s.enumerable });
  return e;
}, "oe");
var V = /* @__PURE__ */ __name2((e, t, n) => (n = e != null ? se(re(e)) : {}, oe(t || !e || !e.__esModule ? U(n, "default", { value: e, enumerable: true }) : n, e)), "V");
var g;
var u = M(() => {
  g = { collectedLocales: [] };
});
...
async function k(e, { request: t, assetsFetcher: n, ctx: s }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        a = S(await n.fetch(L(c, e.path ?? r))), e.headers && _(a.headers, e.headers);
        break;
      }
      case "static": {
        a = await n.fetch(L(c, r));
        break;
      }
      default:
...
async function z(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = K(e, me), a = await s.get(r, { softTags: i });
...
function _e() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await z(n), s) ? s : (we(n), e(n));
  };
}
__name(_e, "_e");
__name2(_e, "_e");
...
var j = /* @__PURE__ */ __name2(class {
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: s, cookie: r } } = t, i = r && this.cookies[r], a = A(i ?? ""), o = A(this.reqCtx.request.headers.get("accept-language") ?? ""), h = [...a, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (h) {
  ...
  async checkPhase(t) {
    ...
    let r = "miss";
    return s || t === "miss" || t === "error" ? r = "hit" : n && (r = H(t)), this.checkPhase(r);
  }
  async run(t = "none") {
...
async function Y(e, t, n, s) {
  let r = new j(t.routes, n, e, s, t.wildcard), i = await ee(r);
  return Ee(e, i, n);
}
__name(Y, "Y");
__name2(Y, "Y");
...
p();
function te() {
  globalThis.__nextOnPagesRoutesIsolation ??= { _map: /* @__PURE__ */ new Map(), getProxyFor: je };
}
__name(te, "te");
__name2(te, "te");
function je(e) {
...
// .wrangler/tmp/pages-FCKRt7/amwf9a60csf.js
...
// .wrangler/tmp/bundle-5s1gJu/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5s1gJu/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=amwf9a60csf.js.map
