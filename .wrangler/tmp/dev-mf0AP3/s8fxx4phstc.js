...
// .wrangler/tmp/bundle-OwvyTA/checked-fetch.js
...
// .wrangler/tmp/bundle-OwvyTA/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-Tb9Qtt/bundledWorker-0.3014778588841227.mjs
...
var oe = /* @__PURE__ */ __name2((e, t, a, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of re(t))
      !ie.call(e, n) && n !== a && H(e, n, { get: () => t[n], enumerable: !(s = ae(t, n)) || s.enumerable });
  return e;
}, "oe");
var V = /* @__PURE__ */ __name2((e, t, a) => (a = e != null ? se(ne(e)) : {}, oe(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e)), "V");
var g;
var u = N(() => {
  g = { collectedLocales: [] };
});
var f;
var l = N(() => {
  f = { version: 3, routes: { none: [{ src: "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$", headers: { Location: "/$1" }, status: 308, continue: true }, { src: "^/_next/__private/trace$", dest: "/404", status: 404, continue: true }, { src: "^/404/?$", status: 404, continue: true, missing: [{ type: "header", key: "x-prerender-revalidate" }] }, { src: "^/500$", status: 500, continue: true }, { src: "^/?$", has: [{ type: "header", key: "rsc", value: "1" }], dest: "/index.rsc", headers: { vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" }, continue: true, override: true }, { src: "^/((?!.+\\.rsc).+?)(?:/)?$", has: [{ type: "header", key: "rsc", value: "1" }], dest: "/$1.rsc", headers: { vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" }, continue: true, override: true }], filesystem: [{ src: "^/index(\\.action|\\.rsc)$", dest: "/", continue: true }, { src: "^/_next/data/(.*)$", dest: "/_next/data/$1", check: true }, { src: "^/\\.prefetch\\.rsc$", dest: "/__index.prefetch.rsc", check: true }, { src: "^/(.+)/\\.prefetch\\.rsc$", dest: "/$1.prefetch.rsc", check: true }, { src: "^/\\.rsc$", dest: "/index.rsc", check: true }, { src: "^/(.+)/\\.rsc$", dest: "/$1.rsc", check: true }], miss: [{ src: "^/_next/static/.+$", status: 404, check: true, dest: "/_next/static/not-found.txt", headers: { "content-type": "text/plain; charset=utf-8" } }], rewrite: [{ src: "^/_next/data/(.*)$", dest: "/404", status: 404 }, { src: "^/author/(?<nxtPid>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/author/[id].rsc?nxtPid=$nxtPid" }, { src: "^/author/(?<nxtPid>[^/]+?)(?:/)?$", dest: "/author/[id]?nxtPid=$nxtPid" }, { src: "^/journal/(?<nxtPid>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/journal/[id].rsc?nxtPid=$nxtPid" }, { src: "^/journal/(?<nxtPid>[^/]+?)(?:/)?$", dest: "/journal/[id]?nxtPid=$nxtPid" }, { src: "^/paper/(?<nxtPid>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/paper/[id].rsc?nxtPid=$nxtPid" }, { src: "^/paper/(?<nxtPid>[^/]+?)(?:/)?$", dest: "/paper/[id]?nxtPid=$nxtPid" }], resource: [{ src: "^/.*$", status: 404 }], hit: [{ src: "^/_next/static/(?:[^/]+/pages|pages|chunks|runtime|css|image|media|zjp2I\\-K4vCZCB0bnEjrnZ)/.+$", headers: { "cache-control": "public,max-age=31536000,immutable" }, continue: true, important: true }, { src: "^/index(?:/)?$", headers: { "x-matched-path": "/" }, continue: true, important: true }, { src: "^/((?!index$).*?)(?:/)?$", headers: { "x-matched-path": "/$1" }, continue: true, important: true }], error: [{ src: "^/.*$", dest: "/404", status: 404, headers: { "x-next-error-status": "404" } }, { src: "^/.*$", dest: "/500", status: 500, headers: { "x-next-error-status": "500" } }] }, images: { domains: [], sizes: [640, 750, 828, 1080, 1200, 1920, 2048, 3840, 16, 32, 48, 64, 96, 128, 256, 384], remotePatterns: [], minimumCacheTTL: 60, formats: ["image/webp"], dangerouslyAllowSVG: false, contentSecurityPolicy: "script-src 'none'; frame-src 'none'; sandbox;", contentDispositionType: "inline" }, overrides: { "404.html": { path: "404", contentType: "text/html; charset=utf-8" }, "500.html": { path: "500", contentType: "text/html; charset=utf-8" }, "_app.rsc.json": { path: "_app.rsc", contentType: "application/json" }, "_error.rsc.json": { path: "_error.rsc", contentType: "application/json" }, "_document.rsc.json": { path: "_document.rsc", contentType: "application/json" }, "404.rsc.json": { path: "404.rsc", contentType: "application/json" }, "_next/static/not-found.txt": { contentType: "text/plain" } }, framework: { slug: "nextjs", version: "14.2.3" }, crons: [] };
});
var m;
var d = N(() => {
  m = { "/404.html": { type: "override", path: "/404.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/404.rsc.json": { type: "override", path: "/404.rsc.json", headers: { "content-type": "application/json" } }, "/500.html": { type: "override", path: "/500.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/_app.rsc.json": { type: "override", path: "/_app.rsc.json", headers: { "content-type": "application/json" } }, "/_document.rsc.json": { type: "override", path: "/_document.rsc.json", headers: { "content-type": "application/json" } }, "/_error.rsc.json": { type: "override", path: "/_error.rsc.json", headers: { "content-type": "application/json" } }, "/_next/static/chunks/461-fb3c4fda39b28a3b.js": { type: "static" }, "/_next/static/chunks/526-44c41eb01f3904d5.js": { type: "static" }, "/_next/static/chunks/553-dba2b7f5075df59f.js": { type: "static" }, "/_next/static/chunks/624-c46c2d106fe1c236.js": { type: "static" }, "/_next/static/chunks/app/_not-found/page-df6ebe77ac4a17fb.js": { type: "static" }, "/_next/static/chunks/app/about/page-ae0f01d076bf98d1.js": { type: "static" }, "/_next/static/chunks/app/author/[id]/page-c1342d9a6a19ed64.js": { type: "static" }, "/_next/static/chunks/app/author/layout-c48ab5a380729961.js": { type: "static" }, "/_next/static/chunks/app/journal/[id]/page-ca9c4449230f6ab1.js": { type: "static" }, "/_next/static/chunks/app/journal/layout-9ee94aa58a1a119c.js": { type: "static" }, "/_next/static/chunks/app/layout-11f3624b43ab11ab.js": { type: "static" }, "/_next/static/chunks/app/page-b5ea0bac6a40326d.js": { type: "static" }, "/_next/static/chunks/app/paper/[id]/page-1383a1ec2b2fdb32.js": { type: "static" }, "/_next/static/chunks/app/paper/layout-a77833614ce16ee2.js": { type: "static" }, "/_next/static/chunks/app/search/page-54b66b3b456a6151.js": { type: "static" }, "/_next/static/chunks/app/trending/page-264bb06acb1f5428.js": { type: "static" }, "/_next/static/chunks/fd9d1056-8dc2532f0847a6dc.js": { type: "static" }, "/_next/static/chunks/framework-f66176bb897dc684.js": { type: "static" }, "/_next/static/chunks/main-2c39c55fe9241c88.js": { type: "static" }, "/_next/static/chunks/main-app-d590838be9370b5d.js": { type: "static" }, "/_next/static/chunks/pages/_app-6a626577ffa902a4.js": { type: "static" }, "/_next/static/chunks/pages/_error-1be831200e60c5c0.js": { type: "static" }, "/_next/static/chunks/polyfills-78c92fac7aa8fdd8.js": { type: "static" }, "/_next/static/chunks/webpack-c7e333bbcedc596f.js": { type: "static" }, "/_next/static/css/01219c427627a4b0.css": { type: "static" }, "/_next/static/media/19cfc7226ec3afaa-s.woff2": { type: "static" }, "/_next/static/media/21350d82a1f187e9-s.woff2": { type: "static" }, "/_next/static/media/36966cca54120369-s.p.woff2": { type: "static" }, "/_next/static/media/8e9860b6e62d6359-s.woff2": { type: "static" }, "/_next/static/media/b7387a63dd068245-s.woff2": { type: "static" }, "/_next/static/media/ba9851c3c22cd980-s.woff2": { type: "static" }, "/_next/static/media/c5fe6dc8356a8c31-s.woff2": { type: "static" }, "/_next/static/media/df0a9ae256c0569c-s.woff2": { type: "static" }, "/_next/static/media/e1aab0933260df4d-s.woff2": { type: "static" }, "/_next/static/media/e4af272ccee01ff0-s.p.woff2": { type: "static" }, "/_next/static/not-found.txt": { type: "override", path: "/_next/static/not-found.txt", headers: { "content-type": "text/plain" } }, "/_next/static/zjp2I-K4vCZCB0bnEjrnZ/_buildManifest.js": { type: "static" }, "/_next/static/zjp2I-K4vCZCB0bnEjrnZ/_ssgManifest.js": { type: "static" }, "/ads.txt": { type: "static" }, "/favicon.ico": { type: "static" }, "/author/[id]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/author/[id].func.js" }, "/author/[id].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/author/[id].func.js" }, "/journal/[id]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/journal/[id].func.js" }, "/journal/[id].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/journal/[id].func.js" }, "/paper/[id]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/paper/[id].func.js" }, "/paper/[id].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/paper/[id].func.js" }, "/robots.txt": { type: "function", entrypoint: "__next-on-pages-dist__/functions/robots.txt.func.js" }, "/robots.txt.rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/robots.txt.func.js" }, "/search": { type: "function", entrypoint: "__next-on-pages-dist__/functions/search.func.js" }, "/search.rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/search.func.js" }, "/sitemap.xml": { type: "function", entrypoint: "__next-on-pages-dist__/functions/sitemap.xml.func.js" }, "/sitemap.xml.rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/sitemap.xml.func.js" }, "/404": { type: "override", path: "/404.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/500": { type: "override", path: "/500.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/_app.rsc": { type: "override", path: "/_app.rsc.json", headers: { "content-type": "application/json" } }, "/_error.rsc": { type: "override", path: "/_error.rsc.json", headers: { "content-type": "application/json" } }, "/_document.rsc": { type: "override", path: "/_document.rsc.json", headers: { "content-type": "application/json" } }, "/404.rsc": { type: "override", path: "/404.rsc.json", headers: { "content-type": "application/json" } }, "/": { type: "override", path: "/index.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/about.html": { type: "override", path: "/about.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/about/layout,_N_T_/about/page,_N_T_/about", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/about": { type: "override", path: "/about.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/about/layout,_N_T_/about/page,_N_T_/about", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/about.rsc": { type: "override", path: "/about.rsc", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/about/layout,_N_T_/about/page,_N_T_/about", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch", "content-type": "text/x-component" } }, "/index.html": { type: "override", path: "/index.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/index": { type: "override", path: "/index.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/index.rsc": { type: "override", path: "/index.rsc", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch", "content-type": "text/x-component" } }, "/trending.html": { type: "override", path: "/trending.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/trending/layout,_N_T_/trending/page,_N_T_/trending", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/trending": { type: "override", path: "/trending.html", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/trending/layout,_N_T_/trending/page,_N_T_/trending", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch" } }, "/trending.rsc": { type: "override", path: "/trending.rsc", headers: { "x-next-cache-tags": "_N_T_/layout,_N_T_/trending/layout,_N_T_/trending/page,_N_T_/trending", vary: "RSC, Next-Router-State-Tree, Next-Router-Prefetch", "content-type": "text/x-component" } } };
});
var F = U((Ge, $) => {
  "use strict";
  u();
...
var X = U((O) => {
  ...
  function be(e, t) {
    ...
    for (var a = {}, s = t || {}, n = s.decode || Pe, i = 0; i < e.length; ) {
      var r = e.indexOf("=", i);
      if (r === -1)
        break;
      var o = e.indexOf(";", i);
      ...
      if (a[c] === void 0) {
        ...
        h.charCodeAt(0) === 34 && (h = h.slice(1, -1)), a[c] = Te(h, n);
      }
      i = o + 1;
    }
    return a;
...
async function T(e, { request: t, assetsFetcher: a, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await a.fetch(I(c, e.path ?? n))), e.headers && _(r.headers, e.headers);
        break;
      }
      case "static": {
...
async function W(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = z(e, me), r = await s.get(n, { softTags: i });
      ...
      case "POST": {
        let i = globalThis[ge], r = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
          o.data.tags === void 0 && (o.tags ??= z(e, fe) ?? []), await s.set(n, o);
        }, "r");
...
function _e() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await W(a), s) ? s : (Re(a), e(a));
  };
}
__name(_e, "_e");
__name2(_e, "_e");
...
var E = /* @__PURE__ */ __name2(class {
  ...
  async checkPhase(t) {
    ...
    let n = "miss";
    return s || t === "miss" || t === "error" ? n = "hit" : a && (n = A(t)), this.checkPhase(n);
  }
  async run(t = "none") {
...
async function Y(e, t, a, s) {
  let n = new E(t.routes, a, e, s, t.wildcard), i = await ee(n);
  return ke(e, i, a);
}
__name(Y, "Y");
__name2(Y, "Y");
...
async function ke(e, { path: t = "/404", status: a, headers: s, searchParams: n, body: i }, r) {
  ...
  if (i !== void 0)
    ...
    c = await T(r[t], e, { path: t, status: a, headers: s, searchParams: n });
  let h = s.normal;
...
function Ne() {
  ...
  return new Proxy(globalThis, { get: (t, a) => e.has(a) ? e.get(a) : Reflect.get(globalThis, a), set: (t, a, s) => Me.has(a) ? Reflect.set(globalThis, a, s) : (e.set(a, s), true) });
}
__name(Ne, "Ne");
__name2(Ne, "Ne");
...
// .wrangler/tmp/pages-Tb9Qtt/s8fxx4phstc.js
...
// .wrangler/tmp/bundle-OwvyTA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-OwvyTA/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=s8fxx4phstc.js.map
