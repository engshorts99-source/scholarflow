...
// .wrangler/tmp/bundle-ajeJKZ/checked-fetch.js
...
// .wrangler/tmp/bundle-ajeJKZ/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-vQRZSq/bundledWorker-0.6171124394241891.mjs
...
var V = /* @__PURE__ */ __name2((e, t, a) => (a = e != null ? se(ne(e)) : {}, oe(t || !e || !e.__esModule ? O(a, "default", { value: e, enumerable: true }) : a, e)), "V");
var g;
var u = E(() => {
  g = { collectedLocales: [] };
});
...
var k = /* @__PURE__ */ __name2(class {
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], r = U(i ?? ""), o = U(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...r, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (p) {
...
// .wrangler/tmp/pages-vQRZSq/k0jgic7k0es.js
...
// .wrangler/tmp/bundle-ajeJKZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ajeJKZ/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=k0jgic7k0es.js.map
