...
// .wrangler/tmp/bundle-DroJUt/checked-fetch.js
...
// .wrangler/tmp/bundle-DroJUt/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-ifj1qn/bundledWorker-0.729103762936366.mjs
...
var O = /* @__PURE__ */ __name2((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "O");
...
function C(e, t, a) {
  ...
  let s = a ? "" : "i", n = [];
  return { match: (0, F.default)(`%${e}%${s}`, n).exec(t), captureGroupKeys: n };
}
__name(C, "C");
__name2(C, "C");
...
var k = /* @__PURE__ */ __name2(class {
  ...
  async checkPhase(t) {
    ...
    let n = "miss";
    return s || t === "miss" || t === "error" ? n = "hit" : a && (n = U(t)), this.checkPhase(n);
  }
  async run(t = "none") {
...
async function Y(e, t, a, s) {
  let n = new k(t.routes, a, e, s, t.wildcard), i = await ee(n);
  return Ne(e, i, a);
}
__name(Y, "Y");
__name2(Y, "Y");
...
// .wrangler/tmp/pages-ifj1qn/zpds7snycun.js
...
// .wrangler/tmp/bundle-DroJUt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DroJUt/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=zpds7snycun.js.map
